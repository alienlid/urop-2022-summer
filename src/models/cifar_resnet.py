...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, feat_scale=1, wm=1):
        ...
        self.avg_pool_2d = nn.AvgPool2d(4)
    ...
    def forward(self, x, with_latent=False):
        ...
        out = self.layer3(out)
        out = self.layer4(out)
        out = self.avg_pool_2d(out) #F.avg_pool2d(out, 4)
...
def ResNet9(num_classes=10, channels_last=False):
    return resnet9.ResNet9(num_classes, channels_last=channels_last)
