...
m, _ = make_and_restore_model(arch = 'resnet18', dataset = ImageNet('/mnt/cfs/datasets/pytorch_imagenet'), resume_path = 'resnet18_l2_eps0.1.ckpt', pytorch_pretrained = False)
model.append(m)
"""
...
for i in range(2, 3):
	...
	for epoch in range(epochs):
		...
		torch.save(model[i].state_dict(), 'waterbird_' + name[i] + f'_epoch_{epoch + 1}.pt')
