...
train_dataset = CIFAR10C('data', True, 'gaussian_blur', severity, transform_train_finetune)
...
IID_test_dataset = CIFAR10C('data', False, 'gaussian_blur', severity, transform_test_finetune)
